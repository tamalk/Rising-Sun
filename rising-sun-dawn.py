...
dic_trad={'J2':'Ü','I2':'Ú','H2':'Ó','C2':'Í','B2':'É','A2':'Á','F3':'A','E3':'B','G3':'C','D3':'D','H3':'E','C3':'F','I3':'G','B3':'H','JA':'I','A3':'J','A+':'K','C+':'L','E+':'M','G+':'N','I+':'O','J+':'P','H+':'Q','F+':'R','D+':'S','B+':'T','GA':'U','FA':'V','IA':'W','HA':'X','EA':'Y','DA':'Z','BA':'.','AA':',','CA':':','J3':' ','EK':'0','FK':'1','AK':'2','CK':'3','BK':'4','HK':'5','CK':'6','IK':'7','DK':'8','JK':'9','F2':'!','G2':'?','E2':'¿','D2':'¡'}
heute = date.today()
    ...
    if chok == "E" or chok == "e":
        ...
        if (levels  == 1):
            ...
            if (cform == "A"):
                    ...
                    dic_daw = {'A':'E', 'B':'A', 'C':'K', 'D':'+', 'E':'2', 'F':'F', 'G':'E', 'H':'C', 'I':'3', 'J':'G', 'K':'D', '+':'I', '2':'H', '3':'J'} #control2
            elif (cform == "C"):
                    dic_daw = {'A':'J', 'B':'L', 'C':'C', 'D':'3', 'E':'+', 'F':'A', 'G':'D', 'H':'G', 'I':'J', 'J':'I', 'K':'F', '+':'K', '2':'2', '3':'E'}#control3
            elif (cform == "D"):
        ...
        if (leveli > 1):
            ...
            if (header == "A"):
                ...
                trans_dawn = {'J':'3' ,'H':'2' ,'I':'+' ,'D':'K' ,'G':'J' ,'3':'I' ,'C':'H' ,'E':'G' ,'F':'F' ,'2':'E' ,'+':'D' ,'K':'C' ,'A':'B' ,'E':'A'}
            elif (header == "C"):
                trans_dawn = {'E':'3' ,'2':'2' ,'K':'+' ,'F':'K' ,'I':'J' ,'J':'I' ,'G':'H' ,'D':'G' ,'A':'F' ,'+':'E' ,'3':'D' ,'C':'C' ,'L':'B' ,'J':'A'}
            elif (header == "D"):
